...
def _write_report(
    ...
    lines = [
        ...
        "",
        _md_table([
            {"condition": "F0", "definition": "strict C1→H1，正确 action"},
            {"condition": "F1", "definition": "strict C3→H1，过去三步上下文"},
            {"condition": "F2", "definition": "strict C1→AR-H3"},
            {"condition": "F3", "definition": "strict C1→H1，zero action"},
            {"condition": "F4", "definition": "strict C1→H1，同 task/stage shuffle"},
            {"condition": "F5", "definition": "original joint C1→H1，未来帧泄漏对照"},
